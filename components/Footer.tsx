...
export default function Footer() {
    return (
        <footer className="bg-container-color border border-black/10">
            <div className="max-w-4xl mx-auto pt-8 pb-24">
                ...
                <ul className="flex justify-center gap-x-6 mb-8">
                    <li className=""><Link className="text-title-color hover:text-title-color-dark" href="#about">About</Link></li>
                    <li className=""><Link className="text-title-color hover:text-title-color-dark" href="#projects">Projects</Link></li>
                    <li className=""><Link className="text-title-color hover:text-title-color-dark" href="#testimonials">Testimonials</Link></li>
                </ul>
                ...
                <span className="block mt-16 text-title-color text-center text-sm">&#169; s2sharpit - Tushar Saini. All rigths reserved</span>
            </div>
        </footer>
    )
}