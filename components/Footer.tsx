        ...
        <footer id="footer" className="bg-container-color border-t border-t-border-color/10">
            <div className="max-w-4xl mx-auto pt-8 pb-24">
                ...
                <ul className="flex justify-center gap-x-6 mb-8">
                    <li onClick={()=>{handleClickClose('about')}} className="text-title-color hover:text-title-color-dark hover:cursor-pointer">About</li>
                    <li onClick={()=>{handleClickClose('qualification')}} className="text-title-color hover:text-title-color-dark hover:cursor-pointer">Qualification</li>
                    <li onClick={()=>{handleClickClose('testimonials')}} className="text-title-color hover:text-title-color-dark hover:cursor-pointer">Testimonials</li>
                </ul>
