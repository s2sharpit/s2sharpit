        ...
        <footer id="footer" className="bg-container-color border border-black/10">
            <div className="max-w-4xl mx-auto pt-8 pb-24">
                ...
                <div className="flex justify-center text-container-color gap-x-5">
                    <Link target='_blank' className="bg-title-color text-xl p-1 md:p-2 rounded md:rounded-lg inline-flex hover:bg-title-color-dark" href="https://www.linkedin.com/in/s2sharpit"><LinkedIn /></Link>
                    <Link target='_blank' className="bg-title-color text-xl p-1 md:p-2 rounded md:rounded-lg inline-flex hover:bg-title-color-dark" href="https://github.com/s2sharpit"><GitHub /></Link>
